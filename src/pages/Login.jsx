  ...
  return (
    <Layout>
      <div className="max-w-sm mx-auto">
        <h1 className="font-display text-2xl font-semibold mb-1">Acceso de editores</h1>
        <p className="text-sm text-ink-soft mb-6">Solo para admin y ancianos que actualizan el contenido.</p>
        ...
        <p className="text-sm text-ink-soft mt-4 text-center">
          ¿Todavía no tenés cuenta? <Link to="/registro" className="text-petrol underline">Crear cuenta</Link>
        </p>
      </div>
    </Layout>
  )
